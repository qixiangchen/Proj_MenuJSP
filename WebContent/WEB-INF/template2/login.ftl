            ...
            <div region="center" border="false" style="padding:5px;background:#fff;border:1px solid #ccc;">
                <form id="loginForm" action="${ctx}/${url}" method="post">
                    <div style="padding:5px 0;">
                        <label for="login">${nameLabel}:</label>
                        <input type="text" name="${nameId}" style="width:260px;" />
                    </div>
                    <div style="padding:5px 0;">
                        <label for="password">${pwdLabel}:</label>
                        <input type="password" name="${pwdId}" style="width:260px;" />
                    </div>
